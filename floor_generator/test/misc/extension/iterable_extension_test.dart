...
void main() {
  group('sortedByDescending', () {
    test('sorts iterable descending by selector', () {
      final actual = [_Box(4), _Box(0), _Box(2), _Box(1), _Box(3)].sortedByDescending((box) => box.number);
  ...
  group('mapNotNull', () {
    test('applies transformation yielding only non-null values', () {
      final actual = [_NullableBox(0), _NullableBox(null), _NullableBox(1)].mapNotNull((box) => box.number);
  ...
  group('distinctBy', () {
    test('distincts values by selector', () {
      final actual = [_Box(1), _Box(1), _Box(0), _Box(2), _Box(2)].distinctBy((box) => box.number);
...
class _Box {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is _Box && runtimeType == other.runtimeType && number == other.number;
